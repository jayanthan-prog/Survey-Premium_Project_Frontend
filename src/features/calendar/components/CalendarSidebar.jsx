...
const CalendarSidebar = ({
    ...
    return (
        <div className="border-r border-slate-200 bg-white p-4 overflow-y-auto">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">August 2023</h3>
            ...
            <div className="mt-8 space-y-3">
                <h4 className="text-sm font-semibold text-slate-900">My Calendars</h4>
                <div className="space-y-2">
                    {[
                        { name: "Bootcamp", color: "emerald" },
                        { name: "Birthday", color: "pink" },
                        { name: "Reminders", color: "slate" },
                    ].map((cal) => (
