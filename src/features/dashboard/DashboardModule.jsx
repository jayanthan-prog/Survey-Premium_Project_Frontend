...
export const DashboardModule = () => {
    ...
    const stats = [
        { name: "Active Releases", value: "3", icon: ChartBarIcon, sub: "Closing soon: 1", color: "text-blue-600", bg: "bg-blue-50" },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-slate-900 p-5 rounded-xl text-white shadow-lg shadow-slate-200">
                        ...
                        <p className="text-slate-400 text-xs mt-1">Users started but did not submit in the last 24h.</p>
